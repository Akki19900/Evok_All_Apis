...
@Service
public class QrTxnStatusRrnServiceImpl implements QrTxnStatusRrnService {
    ...
    private static String generateQrTxnByRrnkChecksum(JSONObject qrObject, String checkSumKey) {
    ...
    @Override
    public String qrStatusRrn(QrTxnStatusRrn qrTxnStatusRrn) {
        JSONObject obj = getJsonRequest();

        ENC_KEY = qrTxnStatusRrn.getEncKey();

        obj.put("source", qrTxnStatusRrn.getSource());
        obj.put("channel", qrTxnStatusRrn.getChannel());
        obj.put("terminalId", qrTxnStatusRrn.getTerminalId());
        obj.put("extTransactionId", qrTxnStatusRrn.getExtTransactionId());

        System.out.println("Raw Request" + obj.toString());
        String checksum = generateQrTxnByRrnkChecksum(obj, qrTxnStatusRrn.getChecksum());
        System.out.println("Checksum is " + checksum);
        obj.put("checksum", checksum);
        System.out.println("Final string to encrypt is " + obj.toString());
        String encryptedReq = encryptRequest(obj.toString(), qrTxnStatusRrn.getEncKey());
