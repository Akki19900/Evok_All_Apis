...
public class QrReportServiceImpl implements QrReportService {
    ...
    @Override
    public String qrRpt(QrReport qrReport) {
        ...
        String checksum = generateQrChecksum(obj, qrReport.getChecksum());
        System.out.println("Checksum is " + checksum);
        obj.put("checksum", checksum);
        System.out.println("Final string to encrypt is " + obj.toString());
        String encryptedReq = encryptRequest(obj.toString(), qrReport.getEncKey());
