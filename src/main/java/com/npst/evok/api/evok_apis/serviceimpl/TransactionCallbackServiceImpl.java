...
public class TransactionCallbackServiceImpl implements TransactionCallbackService {
    ...
    private static String generateTransactionCallbackChecksum(JSONObject qrObject, String checkSumKey) {
    ...
    @Override
    public String callback(TransactionCallback transactionCallback) {
        ...
        String checksum = generateTransactionCallbackChecksum(obj, transactionCallback.getChecksum());
